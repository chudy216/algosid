...
string reverse(lista* l, lista* l2, lista* pop) {
    lista temp = NULL;
    if (*l2 == NULL || &(*l2)->nast == NULL) {
        cout << "\n" << wyswietl(*pop);
        *l = *pop;
        return "lista zbyt krotka na odwracanie";
    }
...
int main()
{
    ...
    while (1) {
        cout << "Elementy listy sa indeksowane od 1 w zwyz!\nwybierz operacje \n"
            ...
            << "15 - wyznacz wartosc wystepujaca najczesciej\n"
            << "16 - usun elementy niepodzielne przez podana wartosc\n"
            << "17 - odwroc liste iteracyjnie\n"
            << "18 - odwroc liste rekurencyjnie\n"
